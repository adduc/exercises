# Cloning an Alpine Linux Template on vSphere with Terraform (NoCloud Cloud-Init)

This exercise shows how Terraform can be used to clone an Alpine Linux
Template VM on vSphere, and use Cloud-Init with NoCloud datasource to
...
<../ansible/vsphere-alpine-golden-image-cloud-init-nocloud> has been created
