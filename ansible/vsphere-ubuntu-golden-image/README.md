# Creating an Golden VM Image with Ubuntu Linux using Ansible

This exercise demonstrates how Ansible can be used to automate the creation of a
golden VM image with Ubuntu Linux on a vSphere environment. The process involves
downloading an Ubuntu Linux cloud image, customizing it with Ansible, and then
...
This exercise successfully downloads and imports an Ubuntu Linux cloud image,
